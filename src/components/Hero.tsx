        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                <p className="mt-4 text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                    Nuestros servicios de desarrollo web están listos para ayudarte a tener una <span className="text-white font-medium">presencia en línea profesional y atractiva</span>.
                </p>
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    <Link
                        href="#servicios"
                        className="px-8 py-4 border border-white/20 text-white font-medium text-lg rounded-full hover:bg-white/10 transition-all"
                    >
                        Ver Servicios
                    </Link>
                </div>
                ...
                <div className="mt-20 grid grid-cols-3 gap-8 max-w-2xl mx-auto opacity-50">
                    ...
                    <div className="p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 transform -translate-y-4">
